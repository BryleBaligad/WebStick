...
Write-Output ""
Write-Output ""
Write-Output "WebStick $($json.version)  -  (c) Bryle Baligad, 2023 - 2025"
if ((Test-Path .\node.exe) -eq $false) {
...
if ((Test-Path .\node_modules) -eq $false) {
    ...
    Invoke-WebRequest http://local.brylebaligad.com/public/dist/WebStick/0.0.40/node_modules.zip -OutFile node_modules.zip
